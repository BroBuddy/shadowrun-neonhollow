export const Events = [
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 10):</strong><br />Diagnose grid failures and reroute energy manually.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>
               
            <p><strong class="violet">Reaction (DC 12):</strong><br />Navigate the chaos and avoid hazards in the dark.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 12):</strong><br />Push through the brawl and shield others from crossfire.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Agility (DC 10):</strong><br />Dodge debris and gunfire while escaping the scene.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +2 Energy</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R413',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 10):</strong><br />Convince officials you’re just a harmless citizen.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Logic (DC 12):</strong><br />Forge clean credentials on the fly.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Intuition (DC 12):</strong><br />Identify a safe route through the visual chaos.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Reaction (DC 10):</strong><br />React quickly to avoid running into danger.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Agility (DC 10):</strong><br />Slip through the crowds unnoticed and unharmed.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Strength (DC 12):</strong><br />Hold the line or break through violent crowds.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Intuition (DC 10):</strong><br />Locate the source and capture valuable files.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Charisma (DC 8):</strong><br />Sell false leads to rival fixers.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Reaction (DC 8):</strong><br />Evade malfunctioning drones before you're tagged.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -2 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Logic (DC 10):</strong><br />Override a drone’s routine and redirect it.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R422',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 12):</strong><br />Help seal the rupture using brute force and gear.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Find a clean exit before the toxin spreads.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +2 Energy</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R423',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Agility (DC 10):</strong><br />Dash in, grab goods, and escape before backup arrives.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Charisma (DC 8):</strong><br />Convince raiders you’re part of the cleanup crew.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -1 Reputation</li></ul>`,
    },
    {
        id: 'R424',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 10):</strong><br />Decode the pulse and stabilize your implant.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Intuition (DC 12):</strong><br />Resist the mental assault and clear your head.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Reaction (DC 8):</strong><br />Track and intercept the bot mid-run.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Predict the courier’s next location.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R426',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 10):</strong><br />Calm the crowd and rally them away from chaos.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Intuition (DC 8):</strong><br />Piece together what the prophet truly knows.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R431',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 10):</strong><br />Fight off an aggressive ganger blocking your escape.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Agility (DC 8):</strong><br />Slip between crossfire and vanish into the shadows.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 10):</strong><br />Decode the stream before it gets scrubbed.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Intuition (DC 8):</strong><br />Follow the hidden markers to the source.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R433',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 10):</strong><br />Blend in with the crowd and fake a corp ID.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Reaction (DC 12):</strong><br />Duck through blind spots before the scanners catch you.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 10):</strong><br />Ground your system and save your gear from frying.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Strength (DC 8):</strong><br />Drag civilians out of a crashed tram's danger zone.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R435',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Reaction (DC 12):</strong><br />Quickly recover the container before corp drones arrive.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Scan for traps and avoid potential setup.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R436',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 8):</strong><br />Interface with the terminal and pull data before it fades.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Charisma (DC 10):</strong><br />Convince a rival crew to share their decrypted fragment.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 10):</strong><br />Reprogram a med-drone to scan and clear you.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Agility (DC 8):</strong><br />Escape quarantine patrols before they close in.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +2 Energy</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R442',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 8):</strong><br />Convince a trusted informant to discredit the footage.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Intuition (DC 12):</strong><br />Track the origin of the false feed.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R443',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 10):</strong><br />Pull survivors from debris before the fire spreads.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Reaction (DC 8):</strong><br />Dodge falling wreckage and reach the scene first.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R444',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 10):</strong><br />Mediate the deal and win both sides' trust.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Intuition (DC 12):</strong><br />Notice the hidden ambush and slip out early.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R445',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 12):</strong><br />Patch the code manually before your implants fry.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Strength (DC 10):</strong><br />Hold steady and ride out the seizures.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 8):</strong><br />Crack the encryption before rival runners catch on.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Reaction (DC 10):</strong><br />Outrun competitors and reach the cache first.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R451',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 10):</strong><br />Convince a bystander to leak crucial information.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Intuition (DC 12):</strong><br />Track the espionage team's movements and sabotage their plan.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R452',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Agility (DC 8):</strong><br />Navigate the riot safely and avoid danger.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +2 Energy</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Logic (DC 10):</strong><br />Hack into the group's system and disable their riot control equipment.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R453',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 10):</strong><br />Use your influence to calm the crowds.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Investigate the situation to gather intelligence on the corrupt official.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R454',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 10):</strong><br />Enter the tournament and fight for the prize money.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Reaction (DC 8):</strong><br />Bet on another fighter and avoid the fight yourself.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R455',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 10):</strong><br />Analyze the storm's pattern to find the safest route out of the area.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +2 Energy</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Agility (DC 12):</strong><br />Dodge falling debris and move swiftly through the chaos.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R456',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 8):</strong><br />Negotiate a better deal with the black market vendors.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Strength (DC 10):</strong><br />Use force to take the weapons tech by intimidation.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R461',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 12):</strong><br />Investigate the cause of the blackout by accessing nearby systems.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Agility (DC 10):</strong><br />Navigate through the dark streets, avoiding dangers like looters.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +2 Energy</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R462',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Reaction (DC 10):</strong><br />React quickly to avoid the AI's detection systems.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Logic (DC 12):</strong><br />Hack the AI to shut it down before it causes more damage.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R463',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 10):</strong><br />Charge in and confront one of the gangs directly.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Charisma (DC 8):</strong><br />Use diplomacy to try and calm the gangs and stop the violence.</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 12):</strong><br />Use your social influence to sway the public opinion and calm the protesters.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -1 Reputation</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Investigate the scandal and uncover hidden details that could be used for leverage.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R465',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Agility (DC 10):</strong><br />Join the race and prove your driving skills.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +3.000 ¥</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Strength (DC 8):</strong><br />Help a racer with their vehicle to ensure they win the race.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Energy</li></ul>`,
    },
    {
        id: 'R466',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 12):</strong><br />Analyze the virus and help create a makeshift cure.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Charisma (DC 10):</strong><br />Rally the people to stay calm and follow safety procedures.</p>
            <ul class="list-margin"><li><strong>Success:</strong> -1 Heat</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R471',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Logic (DC 12):</strong><br />Analyze the anomaly's source and implement a corrective action to stabilize the system.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Logic</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Spot the hidden cause of the malfunction and anticipate the next failure point.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R472',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 12):</strong><br />Use your strength to physically assert yourself by intimidating the officers.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Strength</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Charisma (DC 10):</strong><br />Charm or persuade the officers, using your wit and presence to smooth over the situation.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Intel</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R473',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Agility (DC 12):</strong><br />Use your agility to quickly navigate the chaotic environment and assist in moving patients to safety.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Agility</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Strength (DC 10):</strong><br />Apply your strength to physically move patients or assist with heavy medical equipment.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R474',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Reaction (DC 12):</strong><br />React quickly to either stash the device in a safe spot or maneuver around others who might notice it.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Agility</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Agility (DC 10):</strong><br />Use your agility to keep the device hidden or avoid suspicion, gaining favor from the right people.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R475',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Intuition (DC 12):</strong><br />Use your instinct and quick thinking to identify the core issue and stabilize the virtual environment.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Intuition</li><li><strong>Fail:</strong> -2 Energy</li></ul>
            
            <p><strong class="violet">Reaction (DC 10):</strong><br />Move swiftly to grab a lost runner’s attention and guide them to safety.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R476',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Charisma (DC 12):</strong><br />Charm your way into a conversation with the influential figure.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Charisma Temporary</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Intuition (DC 10):</strong><br />Pay attention to the subtle body language and hidden cues in the conversation</p>
    ...
    },
    {
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Strength (DC 12):</strong><br />Lift the heavy weight off the person with raw strength.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Strength</li><li><strong>Fail:</strong> -2 Health</li></ul>
            
            <p><strong class="violet">Reaction (DC 10):</strong><br />React fast to avoid getting caught under the wreckage or assist others in getting the person out safely.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> +1 Heat</li></ul>`,
    },
    {
        id: 'R478',
        ...
        content: `<p><strong class="violet">Event:</strong><br />
            ...
            <p><strong class="violet">Agility (DC 12):</strong><br />Use your agility to slip past the guards unnoticed or avoid a confrontation with a quick dodge.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Temporary Agility</li><li><strong>Fail:</strong> +1 Heat</li></ul>
            
            <p><strong class="violet">Logic (DC 10):</strong><br />Use your wit to convince the guards that you belong, citing information or reasoning that gains their trust.</p>
            <ul class="list-margin"><li><strong>Success:</strong> +1 Reputation</li><li><strong>Fail:</strong> -2 Health</li></ul>`,
    },
    {
        id: 'R481',
